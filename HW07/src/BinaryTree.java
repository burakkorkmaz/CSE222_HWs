...
public class BinaryTree<E>
    ...
    public void setLeftSubtree(E element){
        if(root == null)
            return;
        if(root.left != null)
    ...
    public void setRightSubtree(E element){
        if(root == null)
            return;
    ...
    public E getData(BinaryTree<E> tree){
        return tree.root.getData();
    }

    public void setData(BinaryTree<E> tree, E element){
